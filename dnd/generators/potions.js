...
var effects = ["Healing. It instantly regenerates some health when drank.", "Vigor. Gives temporary health when drank.",
    ...
    "Preservation. Stops whatever it's poured on from rotting or degrading.", "Fear. Makes the user terrified.",
...
var label = ["Its name and title in bold letters.", "Its description in ornate elvish.", "Its description in elvish with a relevant mythic story.",
    ...
    "Its name glowing with minor magic.", "A cartoon pig.", "A warning of an ancient curse.",
    ...
    "Saying it's designed for babies.", "Saying that it shouldn’t be drank by anyone under 18.",
    "A note saying it's illegal contraband being confiscated.", "A note saying the alchemist thinks it is its greatest work.",
    ...
    "Shamanistic symbols and shavings.", "No words just a single colour.", "Water damaged with a barely-legible label.",
