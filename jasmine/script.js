...
var SimpleSong = {title:"Simple Song",artist:"The Shins",src:"Simple Song.m4a",}
...
var tempSong = songs[6].src;
console.log("playing " + tempSong)
var currentSong = new Audio(tempSong);
//currentSong.play();
...
function play(trackNumber) {
	...
	//update title info
	document.getElementById(song-name).innerHTML = currentSong.title;
